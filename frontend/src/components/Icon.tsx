 ...
 * ============================================================================
 * 
 * Iconos SVG inline para todo el sistema. Cada icono es un componente
 * React que acepta un tamaño opcional. Esto reemplaza el uso de emojis
 * por iconos vectoriales limpios y escalables.
 * 
 * Uso: <Icon name="dashboard" size={20} />
 * ============================================================================
 */
...
/** Mapa de SVG paths para cada icono del sistema */
 ...
 * Renderiza un icono del mapa de iconos del sistema.
 * 
 * @param name - Nombre del icono (ver mapa 'icons' arriba)
 * @param size - Tamaño en píxeles (por defecto 24)
